    ...
    <div class="jumbotron">
     ...
     <div class="body-content">
        ...
        <div id="general" style="padding-top:60px;">
            <p>
                Инструмент для анализа энергетических систем PowerCalc позволяет производить расчёты для неограниченного числа компоновок неограниченного числа различных аппаратов. Использование базы данных позволяет создавать различные компоновки аппаратов в зависимости от исследуемых задач с использованием общих потребителей, режимов полёта и энергосистем.
                <br />
                ...
                Возможности ПО:
                <ul>
                    <li>добавление новых и изменение уже существующих объектов;</li>
                    <li></li>
                    <li></li>
                </ul>
